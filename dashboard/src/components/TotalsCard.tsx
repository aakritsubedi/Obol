...
export default function TotalsCard({ report, summary, todayComparison, monthComparison }: Props) {
  ...
  return (
    <section
      className="min-w-0 border-l border-hairline py-8 pl-8 max-[760px]:border-l-0 max-[760px]:border-t max-[760px]:py-7 max-[760px]:pl-0"
    ...
    >
      ...
      <div className="mt-7 grid grid-cols-2 gap-x-5 gap-y-5 border-t border-hairline py-2">
        <div className="min-w-0">
          ...
          <small className="mt-1 block text-[10px] text-muted">history window</small>
        </div>
        <div className="min-w-0">
        ...
        <div className="min-w-0">
          ...
          <small className="mt-1 block text-[10px] text-muted">in history</small>
        </div>
      </div>
    </section>
  );
